...
| 지표명 | 정의 | 목표값 | 경고 기준 |
|--------|------|--------|---------|
| 활성 프로젝트 수 | `/output/구축사/` 하위 디렉토리 수 | — | 5개 초과 시 리소스 검토 |
...
```
[ ] /output/구축사/ 하위 디렉토리 수 확인
[ ] /output/구축사/**/*.md 파일 수 확인
[ ] /output/구축사/**/.status 파일에서 current_step 목록 추출
[ ] /output/제안사/ 하위 디렉토리 수 확인
[ ] /output/제안사/**/전략팀/제안서-*.md 파일 수 확인
[ ] /output/제안사/**/정책자금팀/*.md 파일 수 확인
```
