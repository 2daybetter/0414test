...
| 지표명 | 정의 | 목표값 | 경고 기준 |
|--------|------|--------|---------|
| 활성 프로젝트 수 | `/output/구축 파트/` 하위 디렉토리 수 | — | 5개 초과 시 리소스 검토 |
| 주간 산출물 생성 수 | 해당 주 생성된 `.md` 파일 수 | 3개/주 이상 | 0개면 진행 지연 경고 |
...
| 지표명 | 정의 | 목표값 | 경고 기준 |
|--------|------|--------|---------|
| 활성 기회 수 | `/output/제안 파트/` 하위 디렉토리 수 | — | — |
| 제안서 완성 수 | `전략팀/제안서-*.md` 파일 수 | — | — |
| 정책자금 매칭 수 | `정책자금팀/*.md` 파일 수 | — | — |
...
```
[ ] /output/구축 파트/ 하위 디렉토리 수 확인
[ ] /output/구축 파트/**/*.md 파일 수 확인
[ ] /output/구축 파트/**/.status 파일에서 current_step 목록 추출
[ ] /output/제안 파트/ 하위 디렉토리 수 확인
[ ] /output/제안 파트/**/전략팀/제안서-*.md 파일 수 확인
[ ] /output/제안 파트/**/정책자금팀/*.md 파일 수 확인
```
