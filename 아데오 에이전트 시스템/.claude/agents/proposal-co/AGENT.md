...
- 완료 조건: `/output/제안사/{기회명}/영업팀/기회분석-{기회명}.md` 존재

### Step B: 시장/경쟁사 분석

- 입력: Step A 기회 분석 보고서
- 처리: 전략팀 L3에 위임 → 경쟁사 분석 + 제안 전략 수립
- 완료 조건: `/output/제안사/{기회명}/전략팀/제안전략-{기회명}.md` 존재
...
- 완료 조건: `/output/제안사/{기회명}/전략팀/제안서-{기회명}.md` 존재

### Step D: 정책자금 매칭 (선택)

- 트리거: 고객사가 정책자금 지원 대상인 경우
- 처리: 정책자금팀 L3에 위임 → policy-fund-finder 스킬 실행
- 완료 조건: `/output/제안사/{기회명}/정책자금팀/정책자금-{기회명}.md` 존재
