...
이후 모든 단계는 Google Drive 아데오 프로젝트/{프로젝트명}/.status/.status 파일의 `outputs.rfp-context` URL을 우선 참조한다.
...
- 완료 조건: Google Drive 아데오 프로젝트/{프로젝트명}/.status/.status 파일의 `outputs.opportunity-analysis` URL 존재
...
- 완료 조건: Google Drive 아데오 프로젝트/{프로젝트명}/.status/.status 파일의 `outputs.proposal-strategy` URL 존재
...
- 완료 조건: Google Drive 아데오 프로젝트/{프로젝트명}/.status/.status 파일의 `outputs.proposal` Figma URL 존재
...
- 완료 조건: Google Drive 아데오 프로젝트/{프로젝트명}/.status/.status 파일의 `outputs.policy-fund` Drive URL 존재
