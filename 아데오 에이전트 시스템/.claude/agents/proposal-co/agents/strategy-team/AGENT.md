...
| 필수 입력 | 확인 방법 |
|---------|---------|
| 제안 분석 보고서 | `/output/제안 파트/{기회명}/영업팀/기회분석-{기회명}.md` |
| RFP 원문 | 파일 경로 또는 텍스트 |
...
Step B 완료 후 제안서 작성 전 반드시 비서실 승인을 받는다.
...
- **입력**: `/output/제안 파트/{기회명}/정책자금팀/정책자금-{기회명}.md`
- **처리**: 아데오 조건에 맞는 정책자금 제안서 작성
- **출력 경로**: `/output/제안 파트/{기회명}/전략팀/정책자금제안서-{기회명}.md`
...
| 분기 시점 | 확인 내용 | 처리 방식 |
|---------|---------|---------|
| Step C 진입 전 | 핵심 메시지 + 차별화 전략 | [확인 요청] 비서실 승인 후 대기 |
...
- 핵심 메시지 비서실 미승인 상태에서 Step C 진행 불가
